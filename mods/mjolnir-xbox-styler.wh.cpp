...
// selectors + CoreWindow discovery) is reused unchanged. Original source:
// https://github.com/ramensoftware/windhawk-mods
//
// PROVING BUILD (v0.1.0): the engine compiles identically to the upstream mod;
// the bundled Start-menu themes and Start-menu-specific code are inert here and
// will be stripped before any public submission. Drive customization via the
// "Control styles" setting (e.g. target NavItem_ButtonLabel, Foreground=#FF6A00).
